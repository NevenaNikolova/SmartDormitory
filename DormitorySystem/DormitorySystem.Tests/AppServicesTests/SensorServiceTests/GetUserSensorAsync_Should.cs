...
{
    [TestClass]
    public class GetUserSensorAsync_Should
    {
        [TestMethod]
        public async Task ReturnProperUserSensor_WhenValidIdIsPassed()
        {
            //Arrange
                ...
                seedUsersMock.Object, seedApiDataMock.Object))
            {
                ...
                var result = await service.GetUserSensorAsync(userSensor.Id);

                Assert.AreEqual(userSensor.PollingInterval, result.PollingInterval);
            }
        }
        ...
        public async Task ThrowSensorNullableException_WhenInvalidIdIsPassed()
        {
                ...
                seedUsersMock.Object, seedApiDataMock.Object))
            {
                ...
                var result = await service.GetUserSensorAsync(guid);
            }
        }
    }
}
